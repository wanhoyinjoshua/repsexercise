...
const Index = () => {
  ...
  return (
    <div  >
       {loading && (
        <div className='h-full parent-container flex items-center justify-center'>
        <div role="status" className='centered-element'>
        <svg aria-hidden="true" className=" text-center w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">

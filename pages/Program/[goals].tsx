...
{goalloading?<div className="flex-1">
  ...
  <div className="h-full rounded-lg bg-gray-100 lg:col-span-2">
    {activevideo==null?<div className="grid h-50 px-4 bg-white place-content-center">
  <h1 className="tracking-widest text-gray-500 uppercase">No Exercises Recommendations yet</h1>
</div>: <div className='h-fit rounded-lg bg-gray-200 lg:col-span-2 bg-black'>
